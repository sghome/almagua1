...
void main() {
  const vec3 c1 = vec3(0.416,0.659,0.31); // Escala de verde
  const vec3 c2 = vec3(0.329,0.525,0.247); // Escala de verde
  const vec3 c3 = vec3(0.29,0.459,0.216); // Escala de verde
  const vec3 c4 = vec3(0.247,0.392,0.184); // Escala de verde
  const vec3 c5 = vec3(0.1); // Escala de verde
  const vec3 c6 = vec3(0.2); // Escala de verde
